    ...
    <div className='py-4 px-6'>
      ...
      <div className='font-rounded text-center'>
        <p className='text-center font text-white/80 tracking-widest'>
          <span className='text-red-700 font-bold'>Go Guest House</span> Lahore offers premium, exceptionally clean, and secure accommodation tailored for both families and corporate guests. Nestled in the vibrant heart of <span className='text-red-700 font-bold'>Johar Town</span>, our strategic location places you just minutes away from major landmarks, including <span className='text-red-700 font-bold'>Emporium Mall</span>, <span className='text-red-700 font-bold'>the Expo Center</span>, <span className='text-red-700 font-bold'>Shaukat Khanum Hospital</span>, and the <span className='text-red-700 font-bold'>University of Central Punjab (UCP)</span>. Our thoughtfully furnished rooms feature modern amenities such as high-speed Wi-Fi, Smart TVs with streaming services, pristine attached baths, and full air conditioning. Whether you are visiting Lahore for business, leisure, or medical transit, enjoy the perfect blend of <span className='text-red-700 font-bold'>luxury</span>, <span className='text-red-700 font-bold'>comfort</span>, and unmatched hospitality with our round-the-clock desk service and dedicated secure parking.
        </p>
        <button className='mt-6 border border-red-700 text-red-700 font-bold font-rounded px-6 py-3 rounded-xl hover:bg-red-700/10 transition-all cursor-pointer'>
          READ MORE
        </button>
      </div>
    </div>
