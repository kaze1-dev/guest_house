  ...
  return (
     <div className="relative w-full h-[85vh] md:h-screen overflow-hidden font-rounded">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start pl-6 md:pl-20 z-20 max-w-4xl">
          ...
          <div className=" p-6 md:p-10 rounded-2xl max-w-2xl text-left">
            ...
            <div className="flex mt-6 gap-6 font-rounded">
              <button className="bg-red-600 cursor-pointer flex gap-2 items-center font-bold px-10 py-4 rounded-lg hover:bg-red-800 transition">
                <HiCalendar size={20} />
                BOOK NOW
              </button>
              <button className="border hover:bg-red-600/10 transition-all cursor-pointer flex items-center gap-2 border-red-600 text-red-600 px-10 py-4 rounded-lg">
                <FaWhatsapp size={20} />
